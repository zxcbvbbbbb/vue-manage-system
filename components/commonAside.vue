<template>
  <el-menu :collapse="isCollapse" default-active="2" class="el-menu-vertical-demo" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
    <h3 v-show="!isCollapse">在线的笔记本</h3>
    <h3 v-show="isCollapse">笔记本</h3>
  ...
  data() {
    return {
      asideMenu: [
        ...
        { path: '/check', name: 'check', label: '网页存储检查', icon: 'check' },
        { path: '/znsms', name: 'znsms', label: '智能短信导出', icon: 'chat-line-square' },
        { path: '/user', name: 'user', label: '用户', icon: 'user' },
        {
          label: '其他',
          icon: 'plus',
          children: [
